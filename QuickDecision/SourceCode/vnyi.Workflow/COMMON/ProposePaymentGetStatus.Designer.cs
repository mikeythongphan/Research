...
{
    partial class ProposePaymentGetStatus
    {
        ...
        private void InitializeComponent()
        {
            ...
            ruleconditionreference2.ConditionName = "Close";
            ...
            // ProposePayment
            // 
            this.ProposePayment.Activities.Add(this.New);
            this.ProposePayment.Activities.Add(this.Approve);
            this.ProposePayment.Activities.Add(this.NotApprove);
            this.ProposePayment.Activities.Add(this.RequestEdit);
            this.ProposePayment.Activities.Add(this.Close);
            this.ProposePayment.Activities.Add(this.Edit);
            this.ProposePayment.Name = "ProposePayment";
            // 
            // ProposePaymentGetStatus
            // 
            this.Activities.Add(this.ProposePayment);
            this.Name = "ProposePaymentGetStatus";
