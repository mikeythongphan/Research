...
{
    public sealed partial class ProposePaymentGetStatus : SequentialWorkflowActivity
    {
        public List<PUBSTATUS> pubStatus { get; set; }
        private List<PUBSTATUS> _pubStatus;
        public Status ppStatus { get; set; }
        public ProposePaymentGetStatus()
        {
            InitializeComponent();
        ...
        {
            _pubStatus = PUBSTATUSDAO.SelectByCondition(" ST_ISPROPOSE  = 1 ");
        }
