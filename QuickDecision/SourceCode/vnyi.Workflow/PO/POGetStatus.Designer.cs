...
namespace vnyi.Workflow.PO
{
    partial class POGetStatus
    {
        ...
        private void InitializeComponent()
        {
            ...
            // PO
            // 
            this.PO.Activities.Add(this.New);
            this.PO.Activities.Add(this.Approve);
            this.PO.Activities.Add(this.NotApprove);
            this.PO.Activities.Add(this.RequestEdit);
            this.PO.Activities.Add(this.Close);
            this.PO.Activities.Add(this.Edit);
            this.PO.Name = "PO";
            // 
